...
dataPackDirectory = "data-oldroads"
...
maxPlayers = 0
serverName = "OldRoads"
serverMotd = "Welcome to OldRoads pre-alpha"
statusTimeout = 5 * 1000
replaceKickOnLogin = true
maxPacketsPerSecond = 25
maxPlayersOnlinePerAccount = 3
maxPlayersOutsidePZPerAccount = 3
...
-- NOTE: 0.05 means 5%
playerBaseCriticalChance = 0
-- NOTE: 0.1 means 10%
playerBaseCriticalDamage = 0
...
weaponProficiencyGainMultiplier = 1
...
animusMasteryMaxMonsterXpMultiplier = 0
animusMasteryMonsterXpMultiplier = 0
animusMasteryMonstersXpMultiplier = 0
animusMasteryMonstersToIncreaseXpMultiplier = 0
...
augmentIncreasedDamagePercent = 0
augmentPowerfulImpactPercent = 0
augmentStrongImpactPercent = 0
...
livestreamExperienceMultiplier = 1
...
OTCRFeatures = {
    enableFeature = {
        ...
        118  -- GameWingsAurasEffectsShader
    },
    disableFeature = {
    }
}
